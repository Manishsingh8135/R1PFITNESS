...
const FaqSection = () => {
  return (
    <div id='faq' className="bg-black p-8">
      <h2 className=" text-5xl   lg:text-8xl   font-bold mb-16 text-center bg-clip-text text-transparent bg-gradient-to-bl from-amber-700 via-yellow-300 to-yellow-800">FREQUENTLY ASKED QUESTIONS</h2>
