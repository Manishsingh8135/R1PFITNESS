...
const GlofoxModal: React.FC = () => {
  ...
  return (
    <div>
      <button
        className="px-6 py-4 bg-black border border-maincolor font-bold text-xl text-white rounded-full bg-maincolor hover:bg-maincolor hover:shadow-2xl transition duration-150"
        onClick={openModal}
      >
        Get Now!!
      </button>
